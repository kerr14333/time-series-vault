---
aliases: [40-02-admissible-decompositions.R]
tags: [code, generated]
---

# `R/40-02-admissible-decompositions.R`

Which models can be decomposed at all?

> [!info] Generated file
> Mirror of `R/40-02-admissible-decompositions.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[40-02-admissible-decompositions]]
...
source("R/40-02-admissible-decompositions.R")
```

Back to [[40-02-admissible-decompositions]] · index: [[code-index]]
