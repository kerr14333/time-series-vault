---
aliases: [10-04-ma-processes.R]
tags: [code, generated]
---

# `R/10-04-ma-processes.R`

MA processes: finite memory, and the non-uniqueness of theta.

> [!info] Generated file
> Mirror of `R/10-04-ma-processes.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-04-ma-processes]]
...
source("R/10-04-ma-processes.R")
```

Back to [[10-04-ma-processes]] · index: [[code-index]]
