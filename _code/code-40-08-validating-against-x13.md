---
aliases: [40-08-validating-against-x13.R]
tags: [code, generated]
---

# `R/40-08-validating-against-x13.R`

Prove it against the Census Bureau binary.

> [!info] Generated file
> Mirror of `R/40-08-validating-against-x13.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[40-08-validating-against-x13]]
...
source("R/40-08-validating-against-x13.R")
```

Back to [[40-08-validating-against-x13]] · index: [[code-index]]
