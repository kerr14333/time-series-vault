---
aliases: [30-08-filter-theory.R]
tags: [code, generated]
---

# `R/30-08-filter-theory.R`

What a filter IS, and why frequency is its natural language.

> [!info] Generated file
> Mirror of `R/30-08-filter-theory.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[30-08-filter-theory]]
...
Back to [[30-08-filter-theory]] · index: [[code-index]]
