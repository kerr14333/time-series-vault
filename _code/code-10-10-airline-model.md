---
aliases: [10-10-airline-model.R]
tags: [code, generated]
---

# `R/10-10-airline-model.R`

The airline model on real data.

> [!info] Generated file
> Mirror of `R/10-10-airline-model.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-10-airline-model]]
...
source("R/10-10-airline-model.R")
```

Back to [[10-10-airline-model]] · index: [[code-index]]
