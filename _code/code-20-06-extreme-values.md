---
aliases: [20-06-extreme-values.R]
tags: [code, generated]
---

# `R/20-06-extreme-values.R`

Extreme values: the one nonlinear step.

> [!info] Generated file
> Mirror of `R/20-06-extreme-values.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[20-06-extreme-values]]
...
source("R/20-06-extreme-values.R")
```

Back to [[20-06-extreme-values]] · index: [[code-index]]
