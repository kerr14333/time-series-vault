---
aliases: [10-05-invertibility.R]
tags: [code, generated]
---

# `R/10-05-invertibility.R`

Invertibility, pi-weights, and the unit MA root.

> [!info] Generated file
> Mirror of `R/10-05-invertibility.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-05-invertibility]]
...
source("R/10-05-invertibility.R")
```

Back to [[10-05-invertibility]] · index: [[code-index]]
