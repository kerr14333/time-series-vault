---
aliases: [40-11-validating-general-seats.R]
tags: [code, generated]
---

# `R/40-11-validating-general-seats.R`

Validate the GENERAL SEATS code against X-13, on models that are

> [!info] Generated file
> Mirror of `R/40-11-validating-general-seats.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[40-11-validating-general-seats]]
...
Back to [[40-11-validating-general-seats]] · index: [[code-index]]
