---
aliases: [10-13-model-selection.R]
tags: [code, generated]
---

# `R/10-13-model-selection.R`

AICC, Ljung-Box done right, residual spectrum.

> [!info] Generated file
> Mirror of `R/10-13-model-selection.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-13-model-selection]]
...
source("R/10-13-model-selection.R")
```

Back to [[10-13-model-selection]] · index: [[code-index]]
