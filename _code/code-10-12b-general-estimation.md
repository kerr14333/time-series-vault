---
aliases: [10-12b-general-estimation.R]
tags: [code, generated]
---

# `R/10-12b-general-estimation.R`

10-12b -- Exact ML for a GENERAL ARIMA, built from scratch.

> [!info] Generated file
> Mirror of `R/10-12b-general-estimation.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
