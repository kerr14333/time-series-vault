---
aliases: [30-06-wiener-kolmogorov.R]
tags: [code, generated]
---

# `R/30-06-wiener-kolmogorov.R`

Wiener-Kolmogorov: keep the share of the power that is yours.

> [!info] Generated file
> Mirror of `R/30-06-wiener-kolmogorov.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[30-06-wiener-kolmogorov]]
...
source("R/30-06-wiener-kolmogorov.R")
```

Back to [[30-06-wiener-kolmogorov]] · index: [[code-index]]
