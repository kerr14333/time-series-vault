---
aliases: [10-08-arma-duality.R]
tags: [code, generated]
---

# `R/10-08-arma-duality.R`

Psi-weights, pi-weights, and common factors.

> [!info] Generated file
> Mirror of `R/10-08-arma-duality.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-08-arma-duality]]
...
source("R/10-08-arma-duality.R")
```

Back to [[10-08-arma-duality]] · index: [[code-index]]
