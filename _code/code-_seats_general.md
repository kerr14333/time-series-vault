---
aliases: [_seats_general.R]
tags: [code, generated]
---

# `R/_seats_general.R`

SEATS for an arbitrary (p,d,q)(P,D,Q)_s model.

> [!info] Generated file
> Mirror of `R/_seats_general.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
