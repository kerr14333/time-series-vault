...
Run the R snippets embedded in the notes and fill in their output.

> [!info] Generated file
> Mirror of `R/inline.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
