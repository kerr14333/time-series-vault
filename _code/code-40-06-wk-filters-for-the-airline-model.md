---
aliases: [40-06-wk-filters-for-the-airline-model.R]
tags: [code, generated]
---

# `R/40-06-wk-filters-for-the-airline-model.R`

The three WK filters: gains, weights, and X-11 side by side.

> [!info] Generated file
> Mirror of `R/40-06-wk-filters-for-the-airline-model.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[40-06-wk-filters-for-the-airline-model]]
...
source("R/40-06-wk-filters-for-the-airline-model.R")
```

Back to [[40-06-wk-filters-for-the-airline-model]] · index: [[code-index]]
