---
aliases: [50-08-covid.R]
tags: [code, generated]
---

# `R/50-08-covid.R`

A COVID-like shock, and the three treatment strategies.

> [!info] Generated file
> Mirror of `R/50-08-covid.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[50-08-covid]]
...
source("R/50-08-covid.R")
```

Back to [[50-08-covid]] · index: [[code-index]]
