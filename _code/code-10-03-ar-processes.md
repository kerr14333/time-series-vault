---
aliases: [10-03-ar-processes.R]
tags: [code, generated]
---

# `R/10-03-ar-processes.R`

AR processes: infinite echo.

> [!info] Generated file
> Mirror of `R/10-03-ar-processes.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-03-ar-processes]]
...
source("R/10-03-ar-processes.R")
```

Back to [[10-03-ar-processes]] · index: [[code-index]]
