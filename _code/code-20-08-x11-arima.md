---
aliases: [20-08-x11-arima.R]
tags: [code, generated]
---

# `R/20-08-x11-arima.R`

X-11-ARIMA: extend with forecasts, then filter symmetrically.

> [!info] Generated file
> Mirror of `R/20-08-x11-arima.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[20-08-x11-arima]]
...
source("R/20-08-x11-arima.R")
```

Back to [[20-08-x11-arima]] · index: [[code-index]]
