---
aliases: [40-09-burman-algorithm.R]
tags: [code, generated]
---

# `R/40-09-burman-algorithm.R`

Burman's algorithm, built from scratch.

> [!info] Generated file
> Mirror of `R/40-09-burman-algorithm.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[40-09-burman-algorithm]]
...
Back to [[40-09-burman-algorithm]] · index: [[code-index]]
