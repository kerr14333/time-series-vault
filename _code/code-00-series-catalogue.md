---
aliases: [00-series-catalogue.R]
tags: [code, generated]
---

# `R/00-series-catalogue.R`

00 -- The test series, and what each one breaks.

> [!info] Generated file
> Mirror of `R/00-series-catalogue.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
...
source("R/00-series-catalogue.R")
```
