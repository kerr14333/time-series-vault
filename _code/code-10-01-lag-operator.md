---
aliases: [10-01-lag-operator.R]
tags: [code, generated]
---

# `R/10-01-lag-operator.R`

The lag operator B is just algebra.

> [!info] Generated file
> Mirror of `R/10-01-lag-operator.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-01-lag-operator]]
...
Back to [[10-01-lag-operator]] · index: [[code-index]]
