---
aliases: [30-04-pseudo-spectrum.R]
tags: [code, generated]
---

# `R/30-04-pseudo-spectrum.R`

The pseudo-spectrum: unit roots as infinite peaks.

> [!info] Generated file
> Mirror of `R/30-04-pseudo-spectrum.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[30-04-pseudo-spectrum]]
...
source("R/30-04-pseudo-spectrum.R")
```

Back to [[30-04-pseudo-spectrum]] · index: [[code-index]]
