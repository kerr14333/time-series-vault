---
aliases: [10-12-estimation.R]
tags: [code, generated]
---

# `R/10-12-estimation.R`

ML vs CSS, and why outliers wreck an ARIMA fit.

> [!info] Generated file
> Mirror of `R/10-12-estimation.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[10-12-estimation]]
...
source("R/10-12-estimation.R")
```

Back to [[10-12-estimation]] · index: [[code-index]]
