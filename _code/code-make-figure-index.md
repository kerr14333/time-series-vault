---
aliases: [make-figure-index.R]
tags: [code, generated]
---

# `R/make-figure-index.R`

Generate _meta/figure-index.md, the figure appendix.

> [!info] Generated file
> Mirror of `R/make-figure-index.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
