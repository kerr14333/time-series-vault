---
aliases: [50-07-outliers-and-breaks.R]
tags: [code, generated]
---

# `R/50-07-outliers-and-breaks.R`

AO, LS, TC: getting the TYPE right matters as much as the location.

> [!info] Generated file
> Mirror of `R/50-07-outliers-and-breaks.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[50-07-outliers-and-breaks]]
...
source("R/50-07-outliers-and-breaks.R")
```

Back to [[50-07-outliers-and-breaks]] · index: [[code-index]]
