---
aliases: [20-01-moving-averages-as-filters.R]
tags: [code, generated]
---

# `R/20-01-moving-averages-as-filters.R`

A moving average is a filter. Gain and phase.

> [!info] Generated file
> Mirror of `R/20-01-moving-averages-as-filters.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[20-01-moving-averages-as-filters]]
...
source("R/20-01-moving-averages-as-filters.R")
```

Back to [[20-01-moving-averages-as-filters]] · index: [[code-index]]
