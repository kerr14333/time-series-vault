---
aliases: [30-01-frequency-domain-basics.R]
tags: [code, generated]
---

# `R/30-01-frequency-domain-basics.R`

Frequencies, periods, harmonics, aliasing.

> [!info] Generated file
> Mirror of `R/30-01-frequency-domain-basics.R`. **Edit the script, not this note** — re-run `R/make-code-notes.R` to refresh.
> Concept note: [[30-01-frequency-domain-basics]]
...
source("R/30-01-frequency-domain-basics.R")
```

Back to [[30-01-frequency-domain-basics]] · index: [[code-index]]
